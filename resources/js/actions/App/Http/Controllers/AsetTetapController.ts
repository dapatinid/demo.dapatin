...
/**
* @see \App\Http\Controllers\AsetTetapController::addImage
* @see app/Http/Controllers/AsetTetapController.php:410
...
addImage.url = (args: { asset: number | { id: number } } | [asset: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return addImage.definition.url
...
addImage.form = addImageForm

/**
* @see \App\Http\Controllers\AsetTetapController::deleteImage
* @see app/Http/Controllers/AsetTetapController.php:437
* @route '/aset-tetap/{asset}/images'
*/
...
const AsetTetapController = { index, create, store, show, depreciate, sell, dispose, archive, destroy, pay, addImage, deleteImage }

export default AsetTetapController