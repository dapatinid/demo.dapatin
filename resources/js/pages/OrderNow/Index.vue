<template>
  <div class="flex h-screen">
    ...
    <!-- Product list -->
    <div ref="scrollContainer" class="overflow-auto ms-auto w-full sm:w-[calc(100vw-20rem)] lg:w-[calc(100vw-24rem)] pb-7 bg-gradient-to-br from-blue-100 via-white to-red-100 dark:from-blue-950 dark:via-gray-900 dark:to-red-950 from-10% to-90%">
