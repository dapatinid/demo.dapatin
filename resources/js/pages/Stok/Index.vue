...
const exportUrl = computed(() => {
  ...
  if (userAdmin.value)        params.set('user_admin',  String(userAdmin.value))

  return `/stok/export?${params.toString()}`
})
</script>
    ...
    <div class="p-3 space-y-3">
      ...
      <div class="flex gap-3 items-center">
        ...
        <a
          :href="exportUrl"
          target="_blank"
          class="px-2 py-2.5 rounded-lg text-sm font-medium
                flex items-center gap-2 whitespace-nowrap
        ...
        <table class="min-w-full text-sm">
          ...
          >
            <tr>
              ...
              <th class="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-300">Qty-</th>
              <th class="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-300" :class="user?.level == null ? 'hidden' : ''">Stok(Rp)-</th>
              <th class="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-300">User/Cust/Supp</th>
